...
@Component({
  selector: 'app-high-reach-demolition',
  templateUrl: './high-reach-demolition.component.html',
  styleUrls: ['./high-reach-demolition.component.scss'],
})
export class HighReachDemolitionComponent {
  images: any = [
    {
      navimg: '../../assets/images/image-6.jpg',
      demlolition: 'HIGH-RISE Demolition',
      services: 'services',
      page: 'pages',
