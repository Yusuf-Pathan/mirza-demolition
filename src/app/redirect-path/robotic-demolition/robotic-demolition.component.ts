...
@Component({
  selector: 'app-robotic-demolition',
  templateUrl: './robotic-demolition.component.html',
  styleUrls: ['./robotic-demolition.component.scss'],
})
export class RoboticDemolitionComponent {
  images: any = [
    {
